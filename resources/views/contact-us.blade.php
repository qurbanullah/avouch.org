...
-->
<div class="bg-gray-800 text-gray-100 px-4 py-6">
    ...
    <div
      class="max-w-screen-xl mt-8 mb-8 px-4 grid gap-4 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-6 mx-auto bg-gray-100 text-gray-900 bg-gray-100 text-gray-900 rounded-lg shadow-lg">
      <div class="flex flex-col justify-between">
        <div>
          ...
          <div class="text-gray-700 mt-8">
            <p>Hate forms?</p>
            <p>
                Send us an <span class="underline">email</span> at <span class="text-blue-500">contact-us@avouch.org</span> instead.
            </p>
          </div>
        </div>
      ...
      <form method="POST" action="{{ route('contact-us.store') }}">
        @csrf
            <div class="">
                ...
                <div class="mt-8">
                    <span class="uppercase text-sm text-gray-600 font-bold">Phone No</span>
                    <input
                        class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                        type="text"
                        name="phone"
                ...
                <div class="mt-8">
                    ...
                    <textarea class="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" name="message" placeholder="Message">{{ old('message') }}</textarea>
