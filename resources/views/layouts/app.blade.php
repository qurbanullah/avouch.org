...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Primary Meta Tags -->
        <meta name="title" content="@yield('title', config('app.name') . ' Linux - ' . 'A secure, reliable and user friendly operating system')">
        <meta name="description" content="@yield('description', config('app.name') . ' Linux - ' . 'is a secure, reliable and user friendly operating system')">

        <!-- Open Graph / Facebook -->
        <meta property="og:type" content="website">
        <meta property="og:url" content="{{ config('app.url') }}">
        <meta property="og:title" content="@yield('title', config('app.name') . ' Linux - ' . 'A secure, reliable and user friendly operating system')">
        <meta property="og:description" content="@yield('description', config('app.name') . ' Linux - ' . 'is a secure, reliable and user friendly operating system').">
        <meta property="og:image" content="https://avouch.org/img/og-image.jpg">

        <!-- Twitter -->
        <meta property="twitter:card" content="summary_large_image">
        <meta property="twitter:url" content="{{ config('app.url') }}">
        <meta property="twitter:title" content="@yield('title', config('app.name') . ' Linux - ' . 'A secure, reliable and user friendly operating system')">
        <meta property="twitter:description" content="@yield('description', config('app.name') . ' Linux - ' . 'is a secure, reliable and user friendly operating system').">
        <meta property="twitter:image" content="https://avouch.org/img/og-image.jpg">
        ...
        <!-- itemscope -->
        <meta itemscope itemprop="name" content="@yield('title', config('app.name') . ' Linux - ' . 'A secure, reliable and user friendly operating system')">
        <meta itemscope itemprop="description" content="@yield('description', config('app.name') . ' Linux - ' . 'is a secure, reliable and user friendly operating system').">
        <meta itemscope itemprop="image" content="https://avouch.org/img/og-image.jpg">
                    ...
                    <div class="mt-6 grid grid-cols-12 md:gap-x-8 gap-y-12 sm:mt-12">
                        ...
                        <div class="mt-10 border-t pt-6 pb-16 border-gray-200 dark:border-dark-500">
                            <p class="text-xs text-gray-700 dark:text-gray-400">
                                Avouch Linux, a project of Qurban Ullah.
                            </p>
