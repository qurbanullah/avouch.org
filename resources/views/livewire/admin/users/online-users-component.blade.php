<div class="sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-800">
    <div style="min-height: 770px" class="sm:relative md:h-full flex-col justify-between">
        <div class="">
            <div class="py-2">
                <div>
                    <h2 class="text-xl font-semibold leading-tight">Online Users</h2>
                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="px-6 py-2 text-xs whitespace-no-wrap">
                                                            @if(Cache::has('user-is-online-' . $item['id']))
                                                                @if ( \Carbon\Carbon::parse($item['last_seen']) < now()->subMinutes(5) )
                                                                    <span class="text-yellow-300">Away</span>
                                                                @else
                                                                    <span class="text-green-500">Online</span>
                                                                @endif
                                                            @else
                                                                <span class="text-yellow-500">Offline</span>
                                                            @endif
                                                        </td>
                                                        <td class="px-6 py-2 text-xs whitespace-no-wrap">
