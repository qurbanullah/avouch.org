<div class="sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-800">
    <div style="min-height: 770px" class="sm:relative md:h-full flex-col justify-between">
        <div class="">
            <div class="py-2">
                <div>
                    <h2 class="text-xl font-semibold leading-tight">Users</h2>
                </div>
                                ...
                                <table class="min-w-full divide-y divide-slate-300 dark:divide-slate-600 dark:bg-gray-800 dark:text-white">
                                    <thead>
                                        <tr class="dark:bg-gray-700 ">
                                            ...
                                            <th class="px-6 py-3 text-left text-xs leading-4 font-bold uppercase tracking-wider">Email</th>
                                            <th class="px-6 py-3 text-left text-xs leading-4 font-bold uppercase tracking-wider">Role</th>
                                            <th class="px-6 py-3 text-left text-xs leading-4 font-bold uppercase tracking-wider">Is Active</th>
                                            <th class="px-6 py-3 text-left text-xs leading-4 font-bold uppercase tracking-wider">Online</th>
                                            <th class="px-6 py-3 text-left text-xs leading-4 font-bold uppercase tracking-wider">Last seen</th>
                                            <th class="px-6 py-3 text-right text-xs leading-4 font-bold uppercase tracking-wider">Action</th>
                                        </tr>
                                    </thead>
                                                ...
                                                @foreach ($searchedData as $item)
                                                    <tr>
                                                        ...
                                                        <td class="px-6 py-2 text-xs whitespace-no-wrap">
                                                            ...
                                                            @else
                                                                <span class="inline-flex px-2 text-xs font-semibold leading-5 text-yellow-500 bg-green-100 rounded-full">Inactive</span>
                                                            @endif
                                                        </td>
                                                        <td class="px-6 py-2 text-xs whitespace-no-wrap">
                                                            ...
                                                            @else
                                                            <span class="inline-flex px-2 text-xs font-semibold leading-5 text-yellow-500 bg-green-100 rounded-full">Offline</span>
                                                            @endif
                                                        </td>
                                                        <td class="px-6 py-2 text-xs whitespace-no-wrap">
