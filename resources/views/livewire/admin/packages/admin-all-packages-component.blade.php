<div class="sm:px-6 lg:px-8 pb-4 bg-gray-50 dark:bg-gray-800">
    <div style="min-height: 770px" class="sm:relative md:h-full flex-col justify-between">
        <div class="">
            <div class="py-2">
                <div>
                    <h2 class="text-xl font-semibold leading-tight">Packages</h2>
                </div>
                                ...
                                <table class="min-w-full divide-y divide-slate-300 dark:divide-slate-600 dark:bg-gray-800 dark:text-white">
                                    <thead>
                                        <tr class="dark:bg-gray-700 ">
                                            <th class="px-6 py-3 text-left text-xs leading-4 font-bold uppercase tracking-wider">Base Name</th>
                                            ...
                                            <th class="px-6 py-3 text-left text-xs leading-4 font-bold uppercase tracking-wider">Group</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="px-6 py-2 text-sm whitespace-no-wrap">
                                                            ...
                                                            class="text-blue-500 hover:text-blue-400 dark:text-blue-300 dark:hover:text-blue-400"
                                                                target="_blank"
                                                                href="{{ route('packages.package-info-component', $item->slug) }}">
                                                                {{ $item->slug }}
                                                            </a>
                                                        </td>
                                                        <td class="px-6 py-2 text-sm whitespace-no-wrap">
                ...
                <x-slot name="content">
                    <div class="flex justify-between gap-4">
                        <div class="mt-2">
                            ...
                            <x-jet-input id="name" type="text" wire:model.debounce.800ms="name" />
                            @error('name') <span class="error text-red-500">{{ $message }}</span> @enderror
                        </div>
                        <div class="mt-2">
                            <x-jet-label for="baseName" value="{{ __('Base Name') }}" class="text-sm" />
                            <x-jet-input id="baseName" type="text" wire:model.debounce.800ms="baseName" />
                            @error('baseName') <span class="error text-red-500">{{ $message }}</span> @enderror
                        </div>
                    </div>
                        ...
                        <div class="flex rounded-md shadow-sm w-full">
                            <div class="flex rounded-md shadow-sm w-full">
                                <span class="hidden md:inline-flex items-center pl-2 rounded-l-md border border-r-0 border-gray-300 bg-white text-gray-700 dark:bg-gray-700 dark:text-gray-300 text-sm">
                                    {{ config('app.url') . '/packages/package-info/' }}
                                </span>
                    ...
                    <div class="mt-2 text-xs">
                        <x-jet-label for="groupId" value="{{ __('Groups') }}" class="text-sm" />
                        <select id="groupId" wire:model="groupId" class="form-select block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm dark:bg-gray-700 text-xs">
                            <option value="Select Group">Select Group</option>
                            @if (!empty($groups))
                                @foreach($groups as $item)
                                    <option class="text-xs" value={{ $item->id }}>{{ $item->slug }}</option>
                                @endforeach
                            @endif
                        </select>
                        <x-jet-input-error for="groupId" class="mt-2" />
                    </div>
                    <div class="mt-2">
                        <label>
                    ...
                    <div class="mt-2">
                        <x-jet-label for="shortDescription" value="{{ __('Short Description') }}" class="text-sm" />
                        <x-jet-input id="shortDescription" class="block w-full text-xs" type="text" wire:model.debounce.800ms="shortDescription" />
                        @error('shortDescription') <span class="error text-red-500">{{ $message }}</span> @enderror
                    </div>
                    <div class="mt-2">
                        <x-jet-label for="title" value="{{ __('Content') }}" class="text-sm" />
                        <div class="rounded-md shadow-sm bg-gray-50 dark:bg-gray-700 dark:text-gray-100">
                            <div class="text-xs">
