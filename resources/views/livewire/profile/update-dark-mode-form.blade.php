    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
        <div>
            ...
            <div class="text-sm text-gray-700 dark:text-gray-100">
                {{ __('Set the theme (System deafault, Light mode, Dark mode.') }}
            </div>
        </div>
        <!-- Theme switcher -->
        <div class="mt-5 md:mt-0 md:col-span-2 px-4 py-5 bg-white dark:bg-gray-800 dark:text-gray-50 sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md sm:rounded-md">
