<div class="max-w-7xl mx-auto py-4 sm:px-6 lg:px-8 rounded-md shadow-md dark:bg-gray-700 dark:text-white">
    <div>
        <h1 class="text-2xl font-semibold leading-tight">Edit Post</h1>
    </div>
    <div>
        <div class="mt-4">
        ...
        {{-- <div class="pt-4 text-sm inline-block text-gray-700">
            <select wire:model="professionId" class="h-10 pl-2 pr-8 text-sm placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline" placeholder="Regular input">
                <option>Category</option>
                <option value="1">Agriculture Farmers</option>
                <option value="2">Clerical Workers</option>
                <option value="3">Craft Workers</option>
                <option value="4">Labourer</option>
                <option value="5">Managers</option>
                <option value="6">Operators and Assemblers</option>
                <option value="7">Professionals</option>
                <option value="8">Service and Sales Workers</option>
                <option value="9">Technical Support Workers</option>
            </select>
        </div> --}}
        <div class="pt-4">
            <label class="block text-base ">
                <span class="text-gray-700 dark:text-gray-50">Select Profession Category</span>
