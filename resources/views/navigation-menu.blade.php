    ...
    <nav x-data="{ open: false }" class="sm:fixed sm:top-0 sm:inset-x-0 sm:h-16 sm:z-40 bg-white dark:bg-gray-900 sm:border-b border-gray-100">
                ...
                <div class="flex">
                    ...
                    <div class="flex items-center">
                        <a href="{{ route('home') }}">
                            ...
                            <img src="{{ asset('img/avouch-logo.png') }}" class="block h-12 w-auto sm:pl-2" alt="Avouch">
                        </a>
                    </div>
                    <!-- Theme switcher -->
                        ...
                        <div class="w-full overflow-hidden flex items-center justify-center">
                            <nav class="w-full p-1 sm:h-14 gap-4 md:gap-10 lg:gap-20 overflow-x-auto">
                                <div class="hidden sm:flex sm:gap-8">
                                    ...
                                    @endif
                                    @if (Route::has('downloads.download-releases'))
                                        <a
                                            href="{{ route('downloads.download-releases') }}"
                                            class="w-20 flex flex-col flex-grow items-center justify-center
                                            overflow-hidden whitespace-no-wrap text-sm transition-colors duration-100
                                            ease-in-out dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md focus:text-orange-500">
                                            ...
                                            <span class="text-sm capitalize">Download</span>
                                        </a>
                                    @endif
                                    @if (Route::has('packages.package-home'))
                                        <a
                                            href="{{ route('packages.package-home') }}"
                                            class="w-20 flex flex-col flex-grow items-center justify-center
                                            overflow-hidden whitespace-no-wrap text-sm transition-colors duration-100
                                            ease-in-out dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md focus:text-orange-500">
                                            ...
                                            <span class="text-sm capitalize">Packages</span>
                                        </a>
                                    @endif
                                    @if (Route::has('posts.post-home'))
                                        <a
                                            href="{{ route('posts.post-home') }}"
                                            class="w-20 flex flex-col flex-grow items-center justify-center
                                            overflow-hidden whitespace-no-wrap text-sm transition-colors duration-100
                                            ease-in-out dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md focus:text-orange-500">
                                            ...
                                            <span class="text-sm capitalize">Magazine</span>
                                        </a>
                                    @endif
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="sm:hidden">
            <div>
                ...
                <x-jet-responsive-nav-link href="{{ route('downloads.download-releases') }}" :active="request()->routeIs('downloads.download-releases')">
                    {{ __('Download') }}
                </x-jet-responsive-nav-link>
                <x-jet-responsive-nav-link href="{{ route('packages.package-home') }}" :active="request()->routeIs('packages.package-home')">
                    {{ __('Packages') }}
                </x-jet-responsive-nav-link>
                <x-jet-responsive-nav-link href="{{ route('posts.post-home') }}" :active="request()->routeIs('posts.post-home')">
                    {{ __('Magazine') }}
                </x-jet-responsive-nav-link>
                @auth
