...
return [
    ...
    */
    ...
    'links' => [
        ...
        public_path('groups-images') => storage_path('app/public/groups-images'),
        public_path('packages') => storage_path('app/public/packages'),
        public_path('packages-images') => storage_path('app/public/packages-images'),
        public_path('packages-database') => storage_path('app/public/packages-database'),
        public_path('packages-info-files') => storage_path('app/public/packages-info-files'),
        public_path('package-xml-files') => storage_path('app/public/package-xml-files'),
        public_path('releases') => storage_path('app/public/releases'),
        public_path('downloads') => storage_path('app/public/downloads'),
        public_path('posts-images') => storage_path('app/public/posts-images'),
        public_path('trix-attachment') => storage_path('app/public/trix-attachment'),
    ],
